...
type Documents = {
  ...
  "query allPermissions {\n  gaiaQueries {\n    allPermissions\n  }\n}": typeof types.AllPermissionsDocument;
  ...
  "mutation deletePropertyEntry($ownerKey: String!, $name: String!, $entry: String!) {\n  gaiaMutations {\n    deletePropertyEntry(ownerKey: $ownerKey, name: $name, entry: $entry) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.DeletePropertyEntryDocument;
  ...
  "mutation setProperty($ownerKey: String!, $name: String!, $entry: String!, $input: SetPropertyInput!) {\n  gaiaMutations {\n    setProperty(ownerKey: $ownerKey, name: $name, entry: $entry, input: $input) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}": typeof types.SetPropertyDocument;
  ...
  "mutation upsertPropertyEntry($ownerKey: String!, $name: String!, $entry: String!, $input: UpsertPropertyEntryInput!) {\n  gaiaMutations {\n    upsertPropertyEntry(\n      ownerKey: $ownerKey\n      name: $name\n      entry: $entry\n      input: $input\n    ) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}": typeof types.UpsertPropertyEntryDocument;
  ...
  "mutation createPrivateNote($input: PrivateNoteInput!) {\n  hadesMutations {\n    createPrivateNote(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": typeof types.CreatePrivateNoteDocument;
  ...
  "mutation deletePrivateNote($id: ID!) {\n  hadesMutations {\n    deletePrivateNote(id: $id) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": typeof types.DeletePrivateNoteDocument;
  ...
  "mutation markViewed($textId: ID!) {\n  hadesMutations {\n    markViewed(textId: $textId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.MarkViewedDocument;
  ...
  "query privateNotes($textId: ID!, $pagination: PaginationInput) {\n  hadesQueries {\n    privateNotes(textId: $textId, pagination: $pagination) {\n      items {\n        id\n        textId\n        startOffset\n        endOffset\n        body\n        visibility\n        remoteObject\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}": typeof types.PrivateNotesDocument;
  "query readerAccount {\n  hadesQueries {\n    readerAccount {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n        cefrLevel\n      }\n    }\n  }\n}": typeof types.ReaderAccountDocument;
  "query readerAccounts($remoteUsers: [RemoteUserInput!]!) {\n  hadesQueries {\n    readerAccounts(remoteUsers: $remoteUsers) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n      }\n    }\n  }\n}": typeof types.ReaderAccountsDocument;
  ...
  "query searchReaderAccounts($query: String!, $pagination: PaginationInput) {\n  hadesQueries {\n    searchReaderAccounts(query: $query, pagination: $pagination) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n    }\n  }\n}": typeof types.SearchReaderAccountsDocument;
  "mutation shareNotes($input: ShareNotesInput!) {\n  hadesMutations {\n    shareNotes(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": typeof types.ShareNotesDocument;
  "query viewedReaderTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedReaderTexts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ViewedReaderTextsDocument;
  "query viewedTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedTexts(pagination: $pagination) {\n      items {\n        textId\n        viewedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ViewedTextsDocument;
  ...
  "mutation icarusRemoveVote($postId: ID!) {\n  icarusMutations {\n    removeVote(postId: $postId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.IcarusRemoveVoteDocument;
...
const documents: Documents = {
  ...
  "mutation deletePropertyEntry($ownerKey: String!, $name: String!, $entry: String!) {\n  gaiaMutations {\n    deletePropertyEntry(ownerKey: $ownerKey, name: $name, entry: $entry) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.DeletePropertyEntryDocument,
  "mutation deleteRole($id: ID!) {\n  gaiaMutations {\n    deleteRole(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
  ...
  "mutation upsertPropertyEntry($ownerKey: String!, $name: String!, $entry: String!, $input: UpsertPropertyEntryInput!) {\n  gaiaMutations {\n    upsertPropertyEntry(\n      ownerKey: $ownerKey\n      name: $name\n      entry: $entry\n      input: $input\n    ) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}":
    types.UpsertPropertyEntryDocument,
  "mutation addComment($input: CommentInput!) {\n  hadesMutations {\n    addComment(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
  ...
  "mutation createPrivateNote($input: PrivateNoteInput!) {\n  hadesMutations {\n    createPrivateNote(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}":
    types.CreatePrivateNoteDocument,
  "mutation createSource($name: String!, $url: String!) {\n  hadesMutations {\n    createSource(name: $name, url: $url) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
  ...
  "mutation deletePrivateNote($id: ID!) {\n  hadesMutations {\n    deletePrivateNote(id: $id) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}":
    types.DeletePrivateNoteDocument,
  "mutation discordLogin($code: String!, $state: String!) {\n  hadesMutations {\n    discordLogin(code: $code, state: $state) {\n      token\n      accountId\n      readerAccountId\n      requiresReactivation\n    }\n  }\n}":
  ...
  "mutation markViewed($textId: ID!) {\n  hadesMutations {\n    markViewed(textId: $textId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.MarkViewedDocument,
  "query myVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesQueries {\n    myVote(targetType: $targetType, targetId: $targetId)\n  }\n}":
    types.MyVoteDocument,
  "query privateNotes($textId: ID!, $pagination: PaginationInput) {\n  hadesQueries {\n    privateNotes(textId: $textId, pagination: $pagination) {\n      items {\n        id\n        textId\n        startOffset\n        endOffset\n        body\n        visibility\n        remoteObject\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}":
    types.PrivateNotesDocument,
  "query readerAccount {\n  hadesQueries {\n    readerAccount {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n        cefrLevel\n      }\n    }\n  }\n}":
    types.ReaderAccountDocument,
  "query readerAccounts($remoteUsers: [RemoteUserInput!]!) {\n  hadesQueries {\n    readerAccounts(remoteUsers: $remoteUsers) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n      }\n    }\n  }\n}":
    types.ReaderAccountsDocument,
  "mutation removeVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesMutations {\n    removeVote(targetType: $targetType, targetId: $targetId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.RemoveVoteDocument,
  "query searchReaderAccounts($query: String!, $pagination: PaginationInput) {\n  hadesQueries {\n    searchReaderAccounts(query: $query, pagination: $pagination) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n    }\n  }\n}":
    types.SearchReaderAccountsDocument,
  "mutation shareNotes($input: ShareNotesInput!) {\n  hadesMutations {\n    shareNotes(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}":
    types.ShareNotesDocument,
  "query viewedReaderTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedReaderTexts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}":
    types.ViewedReaderTextsDocument,
  "query viewedTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedTexts(pagination: $pagination) {\n      items {\n        textId\n        viewedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}":
    types.ViewedTextsDocument,
  "mutation hadesVote($input: VoteInput!) {\n  hadesMutations {\n    vote(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
  ...
  "mutation icarusRemoveVote($postId: ID!) {\n  icarusMutations {\n    removeVote(postId: $postId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}":
    types.IcarusRemoveVoteDocument,
  "query threadsFor($remoteObject: String!) {\n  icarusQueries {\n    threadsFor(remoteObject: $remoteObject) {\n      items {\n        id\n        title\n        status\n        remoteObject\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}":
...
export function graphql(
  source: "query account($id: ID!) {\n  gaiaQueries {\n    account(id: $id) {\n      id\n      username\n      personId\n      status\n      provider\n      remoteUsers {\n        type\n        id\n      }\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query account($id: ID!) {\n  gaiaQueries {\n    account(id: $id) {\n      id\n      username\n      personId\n      status\n      provider\n      remoteUsers {\n        type\n        id\n      }\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query accountPermissions($accountId: ID!) {\n  gaiaQueries {\n    accountPermissions(accountId: $accountId)\n  }\n}",
): (typeof documents)["query accountPermissions($accountId: ID!) {\n  gaiaQueries {\n    accountPermissions(accountId: $accountId)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query accountRoles($accountId: ID!) {\n  gaiaQueries {\n    accountRoles(accountId: $accountId)\n  }\n}",
): (typeof documents)["query accountRoles($accountId: ID!) {\n  gaiaQueries {\n    accountRoles(accountId: $accountId)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query accounts($pagination: PaginationInput) {\n  gaiaQueries {\n    accounts(pagination: $pagination) {\n      items {\n        id\n        username\n        personId\n        status\n        provider\n        remoteUsers {\n          type\n          id\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query accounts($pagination: PaginationInput) {\n  gaiaQueries {\n    accounts(pagination: $pagination) {\n      items {\n        id\n        username\n        personId\n        status\n        provider\n        remoteUsers {\n          type\n          id\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query allPermissions {\n  gaiaQueries {\n    allPermissions\n  }\n}",
): (typeof documents)["query allPermissions {\n  gaiaQueries {\n    allPermissions\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation confirmAccountReactivation($token: String!) {\n  gaiaMutations {\n    confirmAccountReactivation(token: $token) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation confirmAccountReactivation($token: String!) {\n  gaiaMutations {\n    confirmAccountReactivation(token: $token) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createRole($name: String!, $description: String) {\n  gaiaMutations {\n    createRole(name: $name, description: $description) {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["mutation createRole($name: String!, $description: String) {\n  gaiaMutations {\n    createRole(name: $name, description: $description) {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deactivateAccount {\n  gaiaMutations {\n    deactivateAccount {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deactivateAccount {\n  gaiaMutations {\n    deactivateAccount {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deletePropertyEntry($ownerKey: String!, $name: String!, $entry: String!) {\n  gaiaMutations {\n    deletePropertyEntry(ownerKey: $ownerKey, name: $name, entry: $entry) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deletePropertyEntry($ownerKey: String!, $name: String!, $entry: String!) {\n  gaiaMutations {\n    deletePropertyEntry(ownerKey: $ownerKey, name: $name, entry: $entry) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteRole($id: ID!) {\n  gaiaMutations {\n    deleteRole(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "query propertySet($ownerKey: String!, $name: String!, $entry: String) {\n  gaiaQueries {\n    propertySet(ownerKey: $ownerKey, name: $name, entry: $entry)\n  }\n}",
): (typeof documents)["query propertySet($ownerKey: String!, $name: String!, $entry: String) {\n  gaiaQueries {\n    propertySet(ownerKey: $ownerKey, name: $name, entry: $entry)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query propertySetSchema($ownerKey: String!, $name: String!) {\n  gaiaQueries {\n    propertySetSchema(ownerKey: $ownerKey, name: $name) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["query propertySetSchema($ownerKey: String!, $name: String!) {\n  gaiaQueries {\n    propertySetSchema(ownerKey: $ownerKey, name: $name) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query propertySetSchemas($ownerKey: String) {\n  gaiaQueries {\n    propertySetSchemas(ownerKey: $ownerKey) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["query propertySetSchemas($ownerKey: String) {\n  gaiaQueries {\n    propertySetSchemas(ownerKey: $ownerKey) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query propertySets($ownerKey: String!, $name: String!) {\n  gaiaQueries {\n    propertySets(ownerKey: $ownerKey, name: $name) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["query propertySets($ownerKey: String!, $name: String!) {\n  gaiaQueries {\n    propertySets(ownerKey: $ownerKey, name: $name) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation registerPropertySetSchema($input: PropertySetSchemaInput!) {\n  gaiaMutations {\n    registerPropertySetSchema(input: $input) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["mutation registerPropertySetSchema($input: PropertySetSchemaInput!) {\n  gaiaMutations {\n    registerPropertySetSchema(input: $input) {\n      id\n      ownerKey\n      name\n      properties\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation requestAccountReactivation($email: String!, $provider: String!) {\n  gaiaMutations {\n    requestAccountReactivation(email: $email, provider: $provider) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation requestAccountReactivation($email: String!, $provider: String!) {\n  gaiaMutations {\n    requestAccountReactivation(email: $email, provider: $provider) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query role($id: ID!) {\n  gaiaQueries {\n    role(id: $id) {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query role($id: ID!) {\n  gaiaQueries {\n    role(id: $id) {\n      id\n      name\n      description\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query rolePermissions($roleId: ID!) {\n  gaiaQueries {\n    rolePermissions(roleId: $roleId)\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation setAccountPermissions($accountId: ID!, $permissions: [String!]!) {\n  gaiaMutations {\n    setAccountPermissions(accountId: $accountId, permissions: $permissions) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation setAccountPermissions($accountId: ID!, $permissions: [String!]!) {\n  gaiaMutations {\n    setAccountPermissions(accountId: $accountId, permissions: $permissions) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation setAccountRoles($accountId: ID!, $roleNames: [String!]!) {\n  gaiaMutations {\n    setAccountRoles(accountId: $accountId, roleNames: $roleNames) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation setAccountRoles($accountId: ID!, $roleNames: [String!]!) {\n  gaiaMutations {\n    setAccountRoles(accountId: $accountId, roleNames: $roleNames) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation setProperty($ownerKey: String!, $name: String!, $entry: String!, $input: SetPropertyInput!) {\n  gaiaMutations {\n    setProperty(ownerKey: $ownerKey, name: $name, entry: $entry, input: $input) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["mutation setProperty($ownerKey: String!, $name: String!, $entry: String!, $input: SetPropertyInput!) {\n  gaiaMutations {\n    setProperty(ownerKey: $ownerKey, name: $name, entry: $entry, input: $input) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation setRolePermissions($roleId: ID!, $permissions: [String!]!) {\n  gaiaMutations {\n    setRolePermissions(roleId: $roleId, permissions: $permissions) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation setRolePermissions($roleId: ID!, $permissions: [String!]!) {\n  gaiaMutations {\n    setRolePermissions(roleId: $roleId, permissions: $permissions) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation suspendAccount($id: ID!) {\n  gaiaMutations {\n    suspendAccount(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation suspendAccount($id: ID!) {\n  gaiaMutations {\n    suspendAccount(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation unsuspendAccount($id: ID!) {\n  gaiaMutations {\n    unsuspendAccount(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation unsuspendAccount($id: ID!) {\n  gaiaMutations {\n    unsuspendAccount(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation upsertPropertyEntry($ownerKey: String!, $name: String!, $entry: String!, $input: UpsertPropertyEntryInput!) {\n  gaiaMutations {\n    upsertPropertyEntry(\n      ownerKey: $ownerKey\n      name: $name\n      entry: $entry\n      input: $input\n    ) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}",
): (typeof documents)["mutation upsertPropertyEntry($ownerKey: String!, $name: String!, $entry: String!, $input: UpsertPropertyEntryInput!) {\n  gaiaMutations {\n    upsertPropertyEntry(\n      ownerKey: $ownerKey\n      name: $name\n      entry: $entry\n      input: $input\n    ) {\n      id\n      ownerKey\n      propertySet\n      entryName\n      values\n      configurable\n      status\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation addComment($input: CommentInput!) {\n  hadesMutations {\n    addComment(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation addComment($input: CommentInput!) {\n  hadesMutations {\n    addComment(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation archiveText($id: ID!) {\n  hadesMutations {\n    archiveText(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation archiveText($id: ID!) {\n  hadesMutations {\n    archiveText(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createAnnotation($input: AnnotationInput!) {\n  hadesMutations {\n    createAnnotation(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createAnnotation($input: AnnotationInput!) {\n  hadesMutations {\n    createAnnotation(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createPrivateNote($input: PrivateNoteInput!) {\n  hadesMutations {\n    createPrivateNote(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createPrivateNote($input: PrivateNoteInput!) {\n  hadesMutations {\n    createPrivateNote(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createSource($name: String!, $url: String!) {\n  hadesMutations {\n    createSource(name: $name, url: $url) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createSource($name: String!, $url: String!) {\n  hadesMutations {\n    createSource(name: $name, url: $url) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation createText($input: ReaderTextInput!) {\n  hadesMutations {\n    createText(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createText($input: ReaderTextInput!) {\n  hadesMutations {\n    createText(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query defineWord($word: String!, $scope: [WordScope!]) {\n  hadesQueries {\n    defineWord(word: $word, scope: $scope) {\n      id\n      term\n      wordType\n      sourceUrl\n      entries {\n        id\n        term\n        wordType\n        sense\n        translations {\n          term\n          wordType\n          usageNotes\n        }\n        examples\n        note\n      }\n      compounds {\n        id\n        term\n        wordType\n        sense\n        translations {\n          term\n          wordType\n          usageNotes\n        }\n        examples\n        note\n      }\n      relatedWords {\n        id\n        term\n        sourceUrl\n      }\n    }\n  }\n}",
): (typeof documents)["query defineWord($word: String!, $scope: [WordScope!]) {\n  hadesQueries {\n    defineWord(word: $word, scope: $scope) {\n      id\n      term\n      wordType\n      sourceUrl\n      entries {\n        id\n        term\n        wordType\n        sense\n        translations {\n          term\n          wordType\n          usageNotes\n        }\n        examples\n        note\n      }\n      compounds {\n        id\n        term\n        wordType\n        sense\n        translations {\n          term\n          wordType\n          usageNotes\n        }\n        examples\n        note\n      }\n      relatedWords {\n        id\n        term\n        sourceUrl\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteAnnotation($id: ID!) {\n  hadesMutations {\n    deleteAnnotation(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
...
): (typeof documents)["mutation deleteComment($id: ID!) {\n  hadesMutations {\n    deleteComment(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deletePrivateNote($id: ID!) {\n  hadesMutations {\n    deletePrivateNote(id: $id) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deletePrivateNote($id: ID!) {\n  hadesMutations {\n    deletePrivateNote(id: $id) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation discordLogin($code: String!, $state: String!) {\n  hadesMutations {\n    discordLogin(code: $code, state: $state) {\n      token\n      accountId\n      readerAccountId\n      requiresReactivation\n    }\n  }\n}",
): (typeof documents)["mutation discordLogin($code: String!, $state: String!) {\n  hadesMutations {\n    discordLogin(code: $code, state: $state) {\n      token\n      accountId\n      readerAccountId\n      requiresReactivation\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation editAnnotation($id: ID!, $body: String!) {\n  hadesMutations {\n    editAnnotation(id: $id, body: $body) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation editAnnotation($id: ID!, $body: String!) {\n  hadesMutations {\n    editAnnotation(id: $id, body: $body) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listAnnotations($textId: ID!, $includeHidden: Boolean) {\n  hadesQueries {\n    annotations(textId: $textId, includeHidden: $includeHidden) {\n      items {\n        id\n        positionId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        replyCount\n        position {\n          id\n          textId\n          startOffset\n          endOffset\n        }\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}",
): (typeof documents)["query listAnnotations($textId: ID!, $includeHidden: Boolean) {\n  hadesQueries {\n    annotations(textId: $textId, includeHidden: $includeHidden) {\n      items {\n        id\n        positionId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        replyCount\n        position {\n          id\n          textId\n          startOffset\n          endOffset\n        }\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listComments($annotationId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  hadesQueries {\n    comments(\n      annotationId: $annotationId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        annotationId\n        parentId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listComments($annotationId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  hadesQueries {\n    comments(\n      annotationId: $annotationId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        annotationId\n        parentId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listSources {\n  hadesQueries {\n    sources {\n      id\n      name\n      url\n    }\n  }\n}",
): (typeof documents)["query listSources {\n  hadesQueries {\n    sources {\n      id\n      name\n      url\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listTexts($pagination: PaginationInput) {\n  hadesQueries {\n    texts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listTexts($pagination: PaginationInput) {\n  hadesQueries {\n    texts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateAnnotation($id: ID!) {\n  hadesQueries {\n    annotation(id: $id) {\n      id\n      positionId\n      body\n      status\n      upvotes\n      downvotes\n      netScore\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateAnnotation($id: ID!) {\n  hadesQueries {\n    annotation(id: $id) {\n      id\n      positionId\n      body\n      status\n      upvotes\n      downvotes\n      netScore\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateText($id: ID!) {\n  hadesQueries {\n    text(id: $id) {\n      id\n      title\n      content\n      language\n      level\n      ownerId\n      sourceId\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateText($id: ID!) {\n  hadesQueries {\n    text(id: $id) {\n      id\n      title\n      content\n      language\n      level\n      ownerId\n      sourceId\n      status\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation markViewed($textId: ID!) {\n  hadesMutations {\n    markViewed(textId: $textId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation markViewed($textId: ID!) {\n  hadesMutations {\n    markViewed(textId: $textId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query myVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesQueries {\n    myVote(targetType: $targetType, targetId: $targetId)\n  }\n}",
): (typeof documents)["query myVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesQueries {\n    myVote(targetType: $targetType, targetId: $targetId)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query privateNotes($textId: ID!, $pagination: PaginationInput) {\n  hadesQueries {\n    privateNotes(textId: $textId, pagination: $pagination) {\n      items {\n        id\n        textId\n        startOffset\n        endOffset\n        body\n        visibility\n        remoteObject\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}",
): (typeof documents)["query privateNotes($textId: ID!, $pagination: PaginationInput) {\n  hadesQueries {\n    privateNotes(textId: $textId, pagination: $pagination) {\n      items {\n        id\n        textId\n        startOffset\n        endOffset\n        body\n        visibility\n        remoteObject\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        totalPages\n        page\n        size\n        totalCount\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query readerAccount {\n  hadesQueries {\n    readerAccount {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n        cefrLevel\n      }\n    }\n  }\n}",
): (typeof documents)["query readerAccount {\n  hadesQueries {\n    readerAccount {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n        cefrLevel\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query readerAccounts($remoteUsers: [RemoteUserInput!]!) {\n  hadesQueries {\n    readerAccounts(remoteUsers: $remoteUsers) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n      }\n    }\n  }\n}",
): (typeof documents)["query readerAccounts($remoteUsers: [RemoteUserInput!]!) {\n  hadesQueries {\n    readerAccounts(remoteUsers: $remoteUsers) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n      roles {\n        key\n        name\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation removeVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesMutations {\n    removeVote(targetType: $targetType, targetId: $targetId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation removeVote($targetType: ReaderVoteTarget!, $targetId: ID!) {\n  hadesMutations {\n    removeVote(targetType: $targetType, targetId: $targetId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query searchReaderAccounts($query: String!, $pagination: PaginationInput) {\n  hadesQueries {\n    searchReaderAccounts(query: $query, pagination: $pagination) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n    }\n  }\n}",
): (typeof documents)["query searchReaderAccounts($query: String!, $pagination: PaginationInput) {\n  hadesQueries {\n    searchReaderAccounts(query: $query, pagination: $pagination) {\n      id\n      gaiaAccountId\n      discordId\n      discordUsername\n      globalName\n      avatar\n      cefrLevel\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation shareNotes($input: ShareNotesInput!) {\n  hadesMutations {\n    shareNotes(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation shareNotes($input: ShareNotesInput!) {\n  hadesMutations {\n    shareNotes(input: $input) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query viewedReaderTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedReaderTexts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query viewedReaderTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedReaderTexts(pagination: $pagination) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query viewedTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedTexts(pagination: $pagination) {\n      items {\n        textId\n        viewedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query viewedTexts($pagination: PaginationInput) {\n  hadesQueries {\n    viewedTexts(pagination: $pagination) {\n      items {\n        textId\n        viewedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation hadesVote($input: VoteInput!) {\n  hadesMutations {\n    vote(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation createThread($input: CreateThreadInput!) {\n  icarusMutations {\n    createThread(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createThread($input: CreateThreadInput!) {\n  icarusMutations {\n    createThread(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deletePost($id: ID!) {\n  icarusMutations {\n    deletePost(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deletePost($id: ID!) {\n  icarusMutations {\n    deletePost(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query listPosts($threadId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  icarusQueries {\n    posts(\n      threadId: $threadId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        threadId\n        parentId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query listPosts($threadId: ID!, $includeHidden: Boolean, $pagination: PaginationInput) {\n  icarusQueries {\n    posts(\n      threadId: $threadId\n      includeHidden: $includeHidden\n      pagination: $pagination\n    ) {\n      items {\n        id\n        threadId\n        parentId\n        body\n        status\n        upvotes\n        downvotes\n        netScore\n        author {\n          type\n          id\n        }\n        authorProfile {\n          id\n          discordId\n          discordUsername\n          globalName\n          avatar\n          cefrLevel\n        }\n        myVote\n        createdAt\n        updatedAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query locateThread($id: ID!) {\n  icarusQueries {\n    thread(id: $id) {\n      id\n      title\n      status\n      remoteObject\n      createdAt\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query locateThread($id: ID!) {\n  icarusQueries {\n    thread(id: $id) {\n      id\n      title\n      status\n      remoteObject\n      createdAt\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation icarusRemoveVote($postId: ID!) {\n  icarusMutations {\n    removeVote(postId: $postId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation icarusRemoveVote($postId: ID!) {\n  icarusMutations {\n    removeVote(postId: $postId) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query threadsFor($remoteObject: String!) {\n  icarusQueries {\n    threadsFor(remoteObject: $remoteObject) {\n      items {\n        id\n        title\n        status\n        remoteObject\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}",
): (typeof documents)["query threadsFor($remoteObject: String!) {\n  icarusQueries {\n    threadsFor(remoteObject: $remoteObject) {\n      items {\n        id\n        title\n        status\n        remoteObject\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation icarusVote($input: ForumVoteInput!) {\n  icarusMutations {\n    vote(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
