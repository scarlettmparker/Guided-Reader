...
type Documents = {
    ...
    "query listTexts($level: CefrLevel, $sourceId: ID, $ownerId: ID, $pagination: PaginationInput) {\n  hadesQueries {\n    texts(\n      level: $level\n      sourceId: $sourceId\n      ownerId: $ownerId\n      pagination: $pagination\n    ) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListTextsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query listTexts($level: CefrLevel, $sourceId: ID, $ownerId: ID, $pagination: PaginationInput) {\n  hadesQueries {\n    texts(\n      level: $level\n      sourceId: $sourceId\n      ownerId: $ownerId\n      pagination: $pagination\n    ) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query listTexts($level: CefrLevel, $sourceId: ID, $ownerId: ID, $pagination: PaginationInput) {\n  hadesQueries {\n    texts(\n      level: $level\n      sourceId: $sourceId\n      ownerId: $ownerId\n      pagination: $pagination\n    ) {\n      items {\n        id\n        title\n        language\n        level\n        ownerId\n        sourceId\n        status\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
